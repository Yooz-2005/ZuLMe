...
type CreateOrderFromReservationRequest struct {
	ReservationID       int64   `json:"reservation_id" form:"reservation_id" binding:"required"` // 预订ID
	...
	PaymentMethod       string  `json:"payment_method" form:"payment_method"`                    // 支付方式（alipay/wechat）

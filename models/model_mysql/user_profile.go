...
type UserProfile struct {
	...
	IdNumber       int32     `gorm:"column:id_number;type:int;comment:证件号码;not null;" json:"id_number"`                                           // 证件号码
	IdExpireDate   time.Time `gorm:"column:id_expire_date;type:datetime;comment:有效期;not null;" json:"id_expire_date"`                             // 有效期
